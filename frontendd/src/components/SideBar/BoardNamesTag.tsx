...
const BoardNamesTag = () => {
    ...
    //     <div key={i}
    //         className={`py-3 text-mediumGrey flex items-center rounded-r-3xl mr-6 text-base font-bold gap-3 pl-6 -ml-1 cursor-pointer bg-mainPurple hover:bg-lightGrey ease transition duration-500 
    //         `
    //     }
    //         onClick={() => route.push(`/user/board/${val._id}`)}
    //     >
